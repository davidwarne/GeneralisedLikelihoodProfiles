function[logpdf] = com_logpdf(n, lambda, nu)
%% COM_LOGPDF compute Conway-Maxwell-Poisson log Probability Density Function.
%
...
logpdf = n*log(lambda) - (nu*gammaln(n+1) + logsum);
return
